...
print("\n2️ Testing orchestrator initialization...")
try:
...
# Test 4: Run analysis
print("\n4️Testing orchestrator analysis...")
try:
...
try:
    ...
    print(
        f"   Failure probability: {prediction['ml_prediction']['failure_probability'] * 100:.1f}%"
    )
except Exception as e:
